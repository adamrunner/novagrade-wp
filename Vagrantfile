...
Vagrant.configure(2) do |config|
  ...
  #TODO: add nginx configuration file
  #TODO: configure mysql usernames and passwords and wp-config.php
  config.vm.provision "shell", inline: <<-SHELL
    ...
    sudo mysql -e "create database doug6875_test; create user 'doug6875_user'@'localhost' identified by password('dp13store'); flush privileges; grant all on *.* to 'doug6875_user'@'localhost';"
  SHELL
end
